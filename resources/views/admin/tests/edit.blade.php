...
@section('title', 'Админ панель редактирование теста')
    ...
    <div class="container">
        ...
        <form action="{{ route('admin.tests.update', $test->id) }}" method="POST">
            ...
            <div class="edit-actions">
                ...
                <a href="{{ route('admin.tests.questions', $test->id) }}" class="btn btn-primary">Управление вопросами</a>
                <a href="{{ route('admin.index') }}" class="btn btn-primary">Назад</a>
            </div>
        </form>
    </div>
@endsection
