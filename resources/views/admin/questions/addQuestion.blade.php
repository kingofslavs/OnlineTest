...
<div class="container">
    ...
    <form action="{{ route('admin.questions.store', $test->id) }}" method="POST" class="question-form">
        @csrf
        <div class="mb-3">
        ...
        <div class="actions">
            ...
            <a href="{{ route('admin.tests.questions', $test->id) }}" class="btn btn-primary">Назад</a>
        </div>
    </form>
</div>
